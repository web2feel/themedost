...
<div class="row">
    <div class="span8">
        ...
        $faqs = FAQ::objects()
            ...
            ->annotate(array('has_attachments' => SqlAggregate::COUNT(
                SqlCase::N()
        ...
        if ($faqs->exists(true)) {
         ...
         <div id="faq">
            ...
            foreach ($faqs as $F) {
                ...
                echo sprintf(
                    '
            <li><i class="icon-file-alt"></i><a href="faq.php?id=%d" >%s &nbsp;%s</a></li>',
                    $F->getId(),
                    Format::htmlchars($F->question),
                    $attachments
                );
            }
            echo '  </ol>
            ...
            <div class="content">
                <section>
                    ...
                    foreach (Topic::objects()
                        ...
                        ->distinct('topic_id')
                        as $t) { ?>
                        <a href="?topicId=<?php echo urlencode($t->getId()); ?>"><?php echo $t->getFullName(); ?></a>
                    <?php } ?>
                </section>
            </div>
        </div>
