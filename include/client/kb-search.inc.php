<div class="row">
    <div class="span8">
        ...
        if ($faqs->exists(true)) {
            ...
            foreach ($faqs as $F) {
                echo sprintf(
                    '<li><i class="icon-file-alt"></i><a href="faq.php?id=%d" class="previewfaq">%s</a></li>',
                    $F->getId(),
                    $F->getLocalQuestion(),
            ...
            <div class="content">
                <section>
                    ...
                    foreach (Topic::objects()
                        ...
                        as $t) { ?>
                        <div><a href="?topicId=<?php echo urlencode($t->getId()); ?>"><?php echo $t->getFullName(); ?></a></div>
                    <?php } ?>
                </section>
                <section>
                    ...
                    foreach (Category::objects()
                        ...
                        ->filter(array('faqs_count__gt' => 0))
                        as $C) { ?>
                        <div><a href="?cid=<?php echo urlencode($C->getId()); ?>"><?php echo $C->getLocalName(); ?></a></div>
                    <?php } ?>
                </section>
            </div>
        </div>
